...
export const metadata: Metadata = {
  ...
  description: "Contact PLANKZ DECKZ for custom skateboard deck builds, local pickup, and reclaimed timber enquiries.",
};

const sections = [{'title': 'Email', 'text': 'plankz.deckz@gmail.com'}, {'title': 'Instagram', 'text': '@plankzdeckz'}, {'title': 'Facebook', 'text': 'https://www.facebook.com/share/1CpHCKqyF6/'}, {'title': 'What to include', 'text': 'Send intended use, board type, dimensions, finish preference, pickup timing, and any reference photos.'}];
    ...
    <main className="bg-warm-white">
      <section className="border-b border-charcoal/10 bg-weathered-grey/30 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <h1 className="mt-4 font-display text-4xl tracking-wide text-brand-gold sm:text-6xl">Contact</h1>
          <p className="mt-5 max-w-2xl text-lg leading-8 text-charcoal/75">For custom build notes, reference images, pickup coordination, or general enquiries, contact PLANKZ DECKZ directly.</p>
        </div>
      </section>
