...
export const metadata: Metadata = {
  ...
  description:
    "Contact PLANKZ DECKZ by email, Instagram, or Facebook for finished boards, the OG tee, and local pickup.",
};
...
const includeItems = [
  "The name or URL of the product you are asking about.",
  "Your order reference, if you have already bought it.",
  "Any question about the listed board, tee sizing, or pickup.",
  "Preferred Perth-area pickup timing once your order is confirmed.",
];
      ...
      <section className="border-b border-charcoal/10 bg-weathered-gray/35 px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <p className="mt-5 max-w-3xl text-lg leading-8 text-charcoal/75">
            Contact PLANKZ DECKZ for questions about listed boards, the OG tee, and local pickup in
            Western Australia.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-5xl gap-6 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-3xl bg-charcoal p-8 text-warm-white">
            ...
            <p className="mt-4 text-sm leading-7 text-warm-white/72">
              Tell us which listed product or order you mean. That helps us answer questions about
              the exact board, tee size, or pickup arrangement.
            </p>
          </div>
